This is an Arduino-based project designed to facilitate communication between a master sensor and a slave GUI. The project contains two core components:
